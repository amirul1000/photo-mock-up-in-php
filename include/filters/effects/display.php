...
$dst = @imagecreatetruecolor(309, 277);
...
imagefilter($dst, IMG_FILTER_BRIGHTNESS, 80);
imagefilter($dst, IMG_FILTER_CONTRAST, -80);
imagefilter($dst, IMG_FILTER_SMOOTH, 5);
imagefilter($dst, IMG_FILTER_GRAYSCALE);
imagecopy ($im,$dst,200,80,0,0,$canvaswidth,$canvasheight); 
$png = "../props/13.png"; 
